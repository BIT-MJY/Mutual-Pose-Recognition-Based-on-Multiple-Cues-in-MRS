...
* **[2022-04]** The extended journal version of MR-SLAM with our proposed method, ***MUC-LOAM***, is accepted by [Unmanned Systems](https://www.worldscientific.com/doi/abs/10.1142/S2301385023410030) (IF=5.3).
* **[2021-10]** [Cues_Poses_Dataset](https://github.com/BIT-MJY/Cues_Poses_Datasets) is available!
* **[2021-08]** Our paper ***Mutual Pose Recognition Based on Multiple Cues in Multi-robot Systems*** is accepted by [2021 4th IEEE International Conference on Unmanned Systems (ICUS)](https://icus2021.c2.org.cn/), Beijing, China.
...
　　├─poses  
　　　├─timePose.txt  
　　　├─truePose.txt (timestamps of gt poses)  
...
```
<div align=center>
<img src="https://github.com/BIT-MJY/Mutual-Pose-Recognition-Based-on-Multiple-Cues-in-MRS/blob/main/img/tx.png" width="180">
<img src="https://github.com/BIT-MJY/Mutual-Pose-Recognition-Based-on-Multiple-Cues-in-MRS/blob/main/img/ty.png" width="180">
<img src="https://github.com/BIT-MJY/Mutual-Pose-Recognition-Based-on-Multiple-Cues-in-MRS/blob/main/img/tx2.png" width="180">
<img src="https://github.com/BIT-MJY/Mutual-Pose-Recognition-Based-on-Multiple-Cues-in-MRS/blob/main/img/ty2.png" width="180">

</div>

## Dataset
You can find the RS16-based toyset [here](https://github.com/BIT-MJY/Cues_Poses_Datasets).
...
Please cite Kai's paper if you use the error propagation mechanism in our code:
```
